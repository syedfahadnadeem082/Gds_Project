...
try:
    ...
    result = gds.run_cypher("""
        ...
        YIELD nodesProcessed, computeMillis, mutateMillis
        RETURN nodesProcessed, computeMillis, mutateMillis;
    """)
...
try:
    ...
    result = gds.run_cypher("""
        MATCH (j:Journal)
        RETURN j.id AS journalId, j.predictedCategory AS predictedCategory
        LIMIT 10;
    """)
