...
# Step 2: Verify the graph projection
try:
    print("Verifying graph projection 'journal_citation_graph'...")
    ...
    print(f"Error verifying graph projection: {e}")
    exit(1)
...
try:
    ...
    """)
    print("Prediction Results (All Journals):")
    pd.set_option('display.max_colwidth', None)
    print(result)
except Exception as e:
